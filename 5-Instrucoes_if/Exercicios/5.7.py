...
favorite_fruits = ["maça", "banana", "laranja"]
...
if ("abacate" in favorite_fruits):
    print("Você realmente gosta de abacates")
if ("graviola" in favorite_fruits):
    print("Você realmente gosta de graviola")