...
buffet = ("paradise", "grelhado do mar", "parmegiana", "camarao no maracuja", "batata frita")

print("Os pratos do buffet:")
for food in buffet:
    print("\t" + food)

# Erro de atribuição em uma tupla
# buffet[4] = "lagosta"
# buffet[3] = "ostra"

buffet = ("paradise", "grelhado do mar", "parmegiana", "ostra", "lagosta")
print("Os novos pratos do buffet são:")
for food in buffet:
    print("\t" + food)